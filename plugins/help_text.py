...
def help_user(bot, update):
    bot.send_message(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="⭕️ Contact DEV ⭕️", url="https://t.me/SerialCoIn")]]),
        parse_mode="html",
...
async def rename_cb(bot, update):
    ...
    await bot.send_message(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="📝 RENAME 📝", callback_data="rename_button"), [InlineKeyboardButton(text="🎥 RENAME VIDEO 🎥", callback_data="rename_button")],
